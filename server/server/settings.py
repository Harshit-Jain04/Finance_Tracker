...
ALLOWED_HOSTS = ['localhost','127.0.0.1','13.235.247.216']
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('HOST'),   # Or your MySQL host
        'PORT': "12910",        # Or your MySQL port
    }
}
...
EMAIL_HOST_PASSWORD = os.getenv('PASSWORD')  # Your email password or app-specific password
# settings.py
